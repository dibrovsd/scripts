...
base_gr as (
    select
        ...
        --
        count(case when days_repair <= 5 then 1 end) as days_repair_cnt_5,
        count(case when days_repair between 6 and 10 then 1 end) as days_repair_cnt_6_10,
        count(case when days_repair between 11 and 15 then 1 end) as days_repair_cnt_11_15,
        count(case when days_repair between 16 and 25 then 1 end) as days_repair_cnt_16_25,
        count(case when days_repair >= 26 then 1 end) as days_repair_cnt_26,
        --
...
cumul_1 as (
    select
        ...
        --
        t.days_repair_cnt_5,
        t.days_repair_cnt_6_10,
        t.days_repair_cnt_11_15,
        t.days_repair_cnt_16_25,
        t.days_repair_cnt_26,
        --
    ...
    select
        ...
        --
        sum(t.days_repair_cnt_5) as days_repair_cnt_5,
        sum(t.days_repair_cnt_6_10) as days_repair_cnt_6_10,
        sum(t.days_repair_cnt_11_15) as days_repair_cnt_11_15,
        sum(t.days_repair_cnt_16_25) as days_repair_cnt_16_25,
        sum(t.days_repair_cnt_26) as days_repair_cnt_26,
        --
...
cumul as (
    select
        ...
        --
        round(f_division(t.days_repair_cnt_5, t.days_repair_cnt) * 100) as days_repair_ratio_5,
        round(f_division(t.days_repair_cnt_6_10, t.days_repair_cnt) * 100) as days_repair_ratio_6_10,
        round(f_division(t.days_repair_cnt_11_15, t.days_repair_cnt) * 100) as days_repair_ratio_11_15,
        round(f_division(t.days_repair_cnt_16_25, t.days_repair_cnt) * 100) as days_repair_ratio_16_25,
        round(f_division(t.days_repair_cnt_26, t.days_repair_cnt) * 100) as days_repair_ratio_26,
        --
...
select
    ...
    c.days_repair_avg,
    --
    c.days_repair_ratio_5,
    c.days_repair_ratio_6_10,
    c.days_repair_ratio_11_15,
    c.days_repair_ratio_16_25,
    c.days_repair_ratio_26,
    --
